...
function ModalCadastroCobrança({ setOpenModalCadastroCobranca, setOpen, client }) {
  const { descricao, setDescricao, vencimento, setVencimento, valor, setValor, setCobrancas, setErroDescricao, setErroVencimento, setErroValor, statusCobranca, setStatusCobranca } = useClients();
