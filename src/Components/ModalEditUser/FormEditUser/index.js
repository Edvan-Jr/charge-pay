...
export default function FormEditUser() {
    ...
    const { setOpen } = useContext(ContextModalEditUser);
    ...
    function validate() {
        !inputValueCadastroNome ? setErrorName(true) : setErrorName(false);
        !inputValueCadastroEmail ? setErrorEmail(true) : setErrorEmail(false);
        (!passwordRepeat && password) ? setErrorConfirmPassword(true) : setErrorConfirmPassword(false);
        (password && passwordRepeat && (password !== passwordRepeat)) ? setErrorInequalPasswords(true) : setErrorInequalPasswords(false);
        return
    }
